...
2. Place the module folder inside your /sites/all/modules/{modulename} or sites/all/themes/{themename} folder. Then enable the module/theme by running ```drush en module_name``` (for more instructions, read the [Drupal documentation page](https://www.drupal.org/node/120641)).
...
For an example column file, click [here](example_files/exampleExpressionData.rpkm).
