...
<ul>
    ...
    <li><p>
            <b>Create an Array Design</b>: Array Design pages can be created in two ways:
        </p>
        <ol>
            <li><p>
                    <b>Sync Array Designs</b>: If your array design has been pre-loaded into Chado then you need to sync the array design.
            ...
            <li><p>
                    <b>Manually Add An Array Design</b>: If your array design is not already present in the Chado database
                    you can create an array design using the
                    <a href="<?php print url('node/add/chado-arraydesign') ?>">Create Array Design page</a>.
...
<ul>
    <li><p>
            <b>Simple Search Tool</b>: A <?php print l('simple search tool', 'chado/arraydesign') ?> is provided for
            finding array designs. This tool relies on Drupal Views.
